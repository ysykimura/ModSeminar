...
For any Weyl group element $w$, there is a full subcategory $\mathscr{C}_w^{\text{f.g.}}$ corresponding to the quantum unipotent subgroup $U_q(\mathfrak{n}^- \cap w \mathfrak{n}^+)$, 
